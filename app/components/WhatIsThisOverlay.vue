    ...
    <AnimatePresence>
      ...
      >
                ...
                >
                  ...
                  <div v-if="activeStory.hasSocials" class="pt-4 border-t border-white/10 space-y-4">
                    <div class="flex flex-wrap gap-2 justify-center">
                      ...
                      <a href="https://github.com/nimiq/song" target="_blank" rel="noopener" class="text-white/50 hover:text-white transition-colors" aria-label="GitHub">
        ...
        <template v-else>
          ...
          <Motion
            class="absolute top-[28%] left-1/2 translate-x-[280px] max-w-xs p-4 rounded-lg callout-box"
          ...
          <Motion
            class="absolute top-[16%] left-1/2 -translate-x-[380px] max-w-xs p-4 rounded-lg callout-box"
            :initial="{ opacity: 0, x: -80, y: -40, scale: 0.85 }"
            :animate="{ opacity: 1, x: 0, y: 0, scale: 1 }"
            :exit="{ opacity: 0, x: -40, y: -20, scale: 0.9 }"
            :transition="{ duration: 0.5, delay: 0.05, ease: [0.16, 1, 0.3, 1] }"
          ...
          <Motion
            class="absolute top-[38%] left-1/2 -translate-x-[680px] max-w-md p-4 rounded-lg callout-box"
          ...
          <Motion
            ...
            :class="isMedium ? 'bottom-[36%] left-1/2 -translate-x-1/2' : 'bottom-[calc(18%+164px)] left-1/2 -translate-x-1/2'"
          ...
          <!-- Credits & Links callout -->
          <Motion
            class="absolute max-w-[280px] p-4 rounded-lg callout-box right-6 bottom-[277px]"
